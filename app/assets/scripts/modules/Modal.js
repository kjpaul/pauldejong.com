class Modal {
    ...
    injectHTML() {
        ...
        <div class="modal--inner">
          <h2 class="section-title section-title--blue section-title--less-margin"><img src="assets/images/icons/mail.svg" class="section-title--icon"> Get in <strong>Touch</strong></h2>
